...
class WC_Product_Cat_List_Walker extends Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$str ='';
        $param =  $_GET["filter_dung-tich"];
        if($param !='')
            $str='?filter_dung-tich=' .  $param;
		$output .= '"><a href="' . get_term_link( $cat_id, $this->tree_type ) . $str. '">' . apply_filters( 'list_product_cats', $cat->name, $cat ) . '</a>';
