...
function GetAdByCode($att,$arg)
{
    ...
    foreach ($datas as $data)
    {
        ...
        $str .= '<a href="' .  $data["vlink"]. '" title="'.  $data["vname"]. '">' . "<img alt='" . $data["vname"]. "' src='". get_site_url() .$data["vimg"] . "' /></a>" ;
...

{
...

    {
        ...
        $data = (array)$data;
            ...
            $str .= '<div class="item" style="background-image: url('. get_site_url() .$data["vimg"] . ');">';
