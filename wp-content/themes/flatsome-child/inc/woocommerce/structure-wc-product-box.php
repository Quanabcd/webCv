...
add_action( 'flatsome_product_box_actions', 'flatsome_woocommerce_get_alt_product_thumbnail', 11 );
...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
		echo '<p class="name product-title"><a href="' . get_the_permalink() . '" title="' . get_the_title() . '">' . get_the_title() . '</a></p>';
	}
}
