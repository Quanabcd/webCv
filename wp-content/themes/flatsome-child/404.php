                ...
                <div class="row">
                    ...
                    <div class="col medium-9">
                        <header class="page-title">
                            <h1 class="page-title"><?php esc_html_e( 'Trang này không tồn tại.', 'flatsome' ); ?></h1>
                        </header><!-- .page-title -->
                        <div class="page-content">
                            <p><?php esc_html_e( 'Có vẻ như không có gì được tìm thấy tại vị trí này. Có thể thử một trong các liên kết dưới đây hoặc tìm kiếm?', 'flatsome' ); ?></p>
                            <?php get_search_form(); ?>
                        </div><!-- .page-content -->
                    </div>
                </div><!-- .row -->
